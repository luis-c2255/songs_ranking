...
def cyber_title(text, icon=None):
    ...
    st.markdown(f'<h1 style="font-family: \'Barrio\', sans-serif; text-align: center; color: #00fff9; text-shadow: 0 0 10px #00fff9;">{icon_html}{ text}</h1>', unsafe_allow_html=True)
